...
function error_exit {
    ...
    echo ""
    echo " Code tips: "
    echo -e "\033[33m1 -> platforms/ios/Atjia/ is not existed. \033[0m"
    echo -e "\033[33m2 -> cannot git pull platforms/ios/Atjia/WeexiOSSDK, you can try a manual operation. \033[0m"
    echo -e "\033[33m3 -> cannot git pull platforms/ios/Atjia/Benmu-iOS-Library, you can try a manual operation. \033[0m"
...
then
    ...
    open Atjia.xcworkspace || error_exit 5
else
