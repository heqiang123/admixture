...
function error_exit {
    ...
    echo -e "\033[33m2 -> cannot remove platforms/ios/Atjia/WeexiOSSDK, please check file permissions. \033[0m"
    echo -e "\033[33m3 -> cannot remove platforms/ios/Atjia/Benmu-iOS-Library, please check file permissions. \033[0m"
...
then
    ...
    open Atjia.xcworkspace || error_exit 7
