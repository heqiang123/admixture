        ...
        <div class="e-calendar">
            <div class="e-date-select">
                ...
                <div class="e-date-monthday">
                    <transition name="fadeY">
                        <div :key="selectDate.day" class="e-date-monthday-select" :class="{'active': !showYear}" @click="openCalendarList"><span>{{keepDoubleDigit(selectDate.month)}}-{{keepDoubleDigit(selectDate.day)}}</span>
                            <span>{{selectDate.weekStr}}</span></div>
                    </transition>
                </div>
            </div>
            <div class="e-calendar-container" v-show="!showYear">
                ...
                <div class="e-calendar-week">
                    <text class="e-calendar-week-day">一</text>
                    <text class="e-calendar-week-day">二</text>
                    <text class="e-calendar-week-day">三</text>
                    <text class="e-calendar-week-day">四</text>
                    <text class="e-calendar-week-day">五</text>
                    <text class="e-calendar-week-day">六</text>
                    <text class="e-calendar-week-day">日</text>
                </div>
