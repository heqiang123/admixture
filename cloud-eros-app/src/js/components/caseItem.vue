<template>
    <div class="case-item" @click="goTo('design.case',{id:item.id})" @appear="onappear()">
        <div class="case-cover">
            <image v-if="appearIsshow" class="cover" resize="cover" :src="`${item.homepageId}?x-oss-process=image/resize,w_800`"></image>
            <div class="cover-Mongolia"></div>
            <div class="designer-info"
                 @disappear="showNav"
                 @appear="hideNav">

                <div class="head-img"><image  v-if="appearIsshow" class="designer-image" resize="stretch" :src="`${item.headUrl}?x-oss-process=image/resize,w_100/crop,x_0,y_0,w_100,h_100/circle,r_100/format,png`"></image></div>
